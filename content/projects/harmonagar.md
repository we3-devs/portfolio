...
featured: true
caseStudy:
  architecture: Microservices architecture with Next.js frontend, FastAPI backend, PostgreSQL with pgvector for embeddings, Redis caching layer, and Docker containerization.
  challenges:
